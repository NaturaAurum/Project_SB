...
namespace SB.Data
{
    ...
    public interface IKeyTable<out TKey, out TValue> where TValue : IKey<TKey>
    {
        IReadOnlyList<TValue> Values { get; }
        IEnumerable<TKey> Keys { get; }
    }
    
    public class KeyTable<TKey, TValue> : ScriptableObject, IKeyTable<TKey, TValue> where TValue : IKey<TKey>
    {
